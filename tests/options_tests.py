...
class TestOptions(unittest.TestCase):
    def test_build_option_symbol(self):
        ...
        bos1 = polygon.build_option_symbol(
            "AA", dt.date(2021, 12, 5), "c", 134.4)
        bos2 = polygon.build_option_symbol(
            "AMD", "211205", "p", 14.23, prefix_o=True)
        bos3 = polygon.build_option_symbol(
            "MSFT", dt.datetime(2021, 12, 5), "put", 7.345
        )
        bos4 = polygon.build_option_symbol("WPGGQ", "211205", "CALL", 134.0)
        bos5 = polygon.build_option_symbol(
            "PPPPPP", dt.date(2021, 12, 5), "P", "134.345"
        )
    ...
    def test_parse_option_symbol(self):
        ...
        bos2 = polygon.parse_option_symbol(
            "O:AA211015C00013000", expiry_format=str)
        bos3 = polygon.parse_option_symbol(
            "AA211015P00015000", output_format=list)
        bos4 = polygon.parse_option_symbol(
            "AMD211015P00037500", output_format=dict, expiry_format=str
        )
        bos5 = polygon.parse_option_symbol("O:AMD211015P00040000")
        bos6 = polygon.parse_option_symbol(
            "NVDA211015C00070000", output_format=list)
        bos7 = polygon.parse_option_symbol(
            "O:NVDA211015C00072500", output_format=dict)
        bos8 = polygon.parse_option_symbol(
            "O:GOOGL211015C00780000", output_format=list)
        bos9 = polygon.parse_option_symbol(
            "GOOGL2211015P00780000", output_format=list)
        bos10 = polygon.parse_option_symbol(
            "O:AMD1211015C00040000", output_format=list)
        ...
        self.assertTrue(
            bos.underlying_symbol == "A"
            and bos.expiry == dt.date(_dt, 10, 15)
            and bos.call_or_put == "C"
            and bos.strike_price == 90
            and bos.option_symbol == "A211015C00090000"
        )
        self.assertTrue(
            bos2.underlying_symbol == "AA"
            and bos2.expiry == f"{_dt}-10-15"
            and bos2.call_or_put == "C"
            and bos2.strike_price == 13
            and bos2.option_symbol == "AA211015C00013000"
        )
        self.assertTrue(
            bos5.underlying_symbol == "AMD"
            and bos5.expiry == dt.date(_dt, 10, 15)
            and bos5.call_or_put == "P"
            and bos5.strike_price == 40
            and bos5.option_symbol == "AMD211015P00040000"
        )

        self.assertEqual(
            bos3, ["AA", dt.date(_dt, 10, 15), "P", 15, "AA211015P00015000"]
        )
        self.assertEqual(
            bos6, ["NVDA", dt.date(_dt, 10, 15), "C", 70,
                   "NVDA211015C00070000"]
        )
        self.assertEqual(
            bos8, ["GOOGL", dt.date(_dt, 10, 15), "C",
                   780, "GOOGL211015C00780000"]
        )
        self.assertEqual(
            bos9, ["GOOGL", dt.date(_dt, 10, 15), "P",
                   780, "GOOGL211015P00780000"]
        )
        self.assertEqual(
            bos10, ["AMD", dt.date(_dt, 10, 15), "C", 40, "AMD211015C00040000"]
        )
    ...
    def test_build_option_symbol_for_tda(self):
        ...
        bos1 = polygon.build_option_symbol_for_tda(
            "AA", dt.date(2021, 12, 5), "c", 134.4
        )
        bos2 = polygon.build_option_symbol_for_tda("AMD", "120521", "p", 14.23)
        bos3 = polygon.build_option_symbol_for_tda(
            "MSFT", dt.datetime(2021, 12, 5), "put", 7.345
        )
        bos4 = polygon.build_option_symbol_for_tda(
            "WPGGQ", "120521", "CALL", 134.0)
        bos5 = polygon.build_option_symbol_for_tda(
            "PPPPPP", dt.date(2021, 12, 5), "P", "134.345"
        )
        bos6 = polygon.build_option_symbol_for_tda(
            "PPPPPP", dt.date(2021, 12, 5), "P", "134.345", format_="dot"
        )
    ...
    def test_parse_option_symbol_from_tda(self):
        ...
        bos3 = polygon.parse_option_symbol_from_tda(
            "AA_101521C134.4", output_format=list
        )
        bos4 = polygon.parse_option_symbol_from_tda(
            "AMD_101521P14.23", output_format=dict, expiry_format=str
        )
        bos6 = polygon.parse_option_symbol_from_tda(
            "MSFT_101521P7.345", output_format=list
        )
        bos8 = polygon.parse_option_symbol_from_tda(
            "WPGGQ_101521C134.0", output_format=list
        )
        bos9 = polygon.parse_option_symbol_from_tda(
            "PPPPPP_101521P134.345", output_format=list
        )
        bos10 = polygon.parse_option_symbol_from_tda(
            ".PPPPPP211015P134.345", output_format=list
        )
        bos11 = polygon.parse_option_symbol_from_tda(
            ".X211015P134", output_format=list)
        ...
        self.assertTrue(
            bos.underlying_symbol == "X"
            and bos.expiry == dt.date(_dt, 10, 15)
            and bos.call_or_put == "C"
            and bos.strike_price == 134
            and bos.option_symbol == "X_101521C134"
        )

        self.assertEqual(
            bos3, ["AA", dt.date(_dt, 10, 15), "C", 134.4, "AA_101521C134.4"]
        )
        self.assertEqual(
            bos6, ["MSFT", dt.date(_dt, 10, 15), "P",
                   7.345, "MSFT_101521P7.345"]
        )
        self.assertEqual(
            bos8, ["WPGGQ", dt.date(_dt, 10, 15), "C",
                   134, "WPGGQ_101521C134.0"]
        )
        self.assertEqual(
            bos9,
            ["PPPPPP", dt.date(_dt, 10, 15), "P", 134.345,
             "PPPPPP_101521P134.345"],
        )
        self.assertEqual(
            bos10,
            ["PPPPPP", dt.date(_dt, 10, 15), "P", 134.345,
        ...
        self.assertEqual(bos11, ["X", dt.date(
            _dt, 10, 15), "P", 134, "X_101521P134"])
    ...
    def test_convert_from_tda_to_polygon_format(self):
        ...
        bos2 = polygon.convert_from_tda_to_polygon_format(
            "AA_101521C134.4", True)
        ...
        bos6 = polygon.convert_from_tda_to_polygon_format(
            "PPPPPP_101521P134.345")
        bos7 = polygon.convert_from_tda_to_polygon_format(
            ".PPPPPP211015P134.345")
    ...
    def test_convert_from_polygon_to_tda_format(self):
        ...
        bos2 = polygon.convert_from_polygon_to_tda_format(
            "O:AA211015C00134400")
        bos3 = polygon.convert_from_polygon_to_tda_format("AMD211015P00014230")
        bos4 = polygon.convert_from_polygon_to_tda_format(
            "MSFT211015P00007345")
        bos5 = polygon.convert_from_polygon_to_tda_format(
            "WPGGQ211015C00134000")
        bos6 = polygon.convert_from_polygon_to_tda_format(
            "PPPPPP211015P00134345")
        bos7 = polygon.convert_from_polygon_to_tda_format(
            "PPPPPP211015P00134345", format_="dot"
        )
        bos8 = polygon.convert_from_polygon_to_tda_format(
            "X211015P00134000", format_="dot"
        )
    ...
    def test_get_trades(self):
        with polygon.OptionsClient(cred.KEY) as client:
            ...
            data2 = client.get_trades(
                "O:TSLA210903C00700000", limit=10, raw_response=True
            )
            data3 = client.get_trades(
                "O:TSLA210903C00700000", limit=5, all_pages=True, max_pages=2
            )
            data4 = client.get_trades(
    ...
    def test_get_quotes(self):
        with polygon.OptionsClient(cred.KEY) as client:
            ...
            data2 = client.get_quotes(
                "O:TSLA210903C00700000", limit=10, raw_response=True
            )
            data3 = client.get_quotes(
                "O:TSLA210903C00700000", limit=5, all_pages=True, max_pages=2
            )
            data4 = client.get_quotes(
                "O:TSLA210903C00700000",
                limit=5,
                all_pages=True,
                max_pages=2,
    ...
    def test_get_last_trade(self):
        with polygon.OptionsClient(cred.KEY) as client:
            ...
            data2 = client.get_last_trade(
                "O:TSLA210903C00700000", raw_response=True)
    ...
    def test_get_daily_open_close(self):
        with polygon.OptionsClient(cred.KEY) as client:
            data = client.get_daily_open_close(
                "O:TSLA210903C00700000", date="2021-07-22"
            )
            data2 = client.get_daily_open_close(
                "TSLA210903C00700000", date=dt.date(2021, 7, 22), raw_response=True
            )
    ...
    def test_get_aggregate_bars(self):
        with polygon.OptionsClient(cred.KEY) as client:
            data = client.get_aggregate_bars(
                "O:TSLA210903C00700000", "2021-09-10", dt.date(2021, 10, 1), limit=30
            )
            data2 = client.get_aggregate_bars(
                "O:TSLA210903C00700000",
                dt.date(2021, 9, 10),
                "2021-10-01",
                limit=30,
            ...
            data4 = client.get_aggregate_bars(
                "TSLA210903C00700000",
                "2021-09-10",
                dt.date(2021, 10, 1),
                full_range=True,
            ...
            data3 = client.get_aggregate_bars(
                "O:TSLA210903C00700000",
                "2021-09-10",
                dt.date(2021, 10, 1),
                full_range=True,
            ...
            data5 = client.get_aggregate_bars(
                "TSLA210903C00700000",
                "2021-06-10",
                dt.date(2021, 10, 1),
                full_range=True,
            ...
            data6 = client.get_aggregate_bars(
                "O:TSLA210903C00700000",
                "2021-06-10",
                dt.date(2021, 10, 1),
                full_range=True,
    ...
    def test_get_snapshot(self):
        with polygon.OptionsClient(cred.KEY) as client:
            ...
            data2 = client.get_snapshot(
                "AAPL", "O:AAPL230616C00150000", raw_response=True
            )
            data3 = client.get_snapshot(
                "AAPL", "O:AAPL230616C00150000", all_pages=True, max_pages=2
            )
            data4 = client.get_snapshot(
                "AAPL",
    ...
    def test_get_previous_close(self):
        with polygon.OptionsClient(cred.KEY) as client:
            ...
            data2 = client.get_previous_close(
                "O:TSLA210903C00700000", adjusted=True, raw_response=True
            )
    ...
    async def test_async_get_trades(self):
        async with polygon.OptionsClient(cred.KEY, True) as client:
            ...
            data2 = await client.get_trades(
                "O:TSLA210903C00700000", limit=10, raw_response=True
            )
            data3 = await client.get_trades(
                "O:TSLA210903C00700000", limit=5, all_pages=True, max_pages=2
            )
            data4 = await client.get_trades(
                "O:TSLA210903C00700000",
                limit=5,
                all_pages=True,
                max_pages=2,
    ...
    async def test_async_get_quotes(self):
        async with polygon.OptionsClient(cred.KEY, True) as client:
            ...
            data2 = await client.get_quotes(
                "O:TSLA210903C00700000", limit=10, raw_response=True
            )
            data3 = await client.get_quotes(
                "O:TSLA210903C00700000", limit=5, all_pages=True, max_pages=2
            )
            data4 = await client.get_quotes(
                "O:TSLA210903C00700000",
                limit=5,
                all_pages=True,
                max_pages=2,
    ...
    async def test_async_get_last_trade(self):
        async with polygon.OptionsClient(cred.KEY, use_async=True) as client:
            ...
            data2 = await client.get_last_trade(
                "O:TSLA210903C00700000", raw_response=True
            )
    ...
    async def test_async_get_daily_open_close(self):
        async with polygon.OptionsClient(cred.KEY, True) as client:
            data = await client.get_daily_open_close(
                "O:TSLA210903C00700000", date="2021-07-22"
            )
            data2 = await client.get_daily_open_close(
                "TSLA210903C00700000", date=dt.date(2021, 7, 22), raw_response=True
            )
    ...
    async def test_async_get_aggregate_bars(self):
        async with polygon.OptionsClient(cred.KEY, True) as client:
            data = await client.get_aggregate_bars(
                "O:TSLA210903C00700000", "2021-09-10", dt.date(2021, 10, 1), limit=30
            )
            data2 = await client.get_aggregate_bars(
                "O:TSLA210903C00700000",
                dt.date(2021, 9, 10),
                "2021-10-01",
                limit=30,
            ...
            data4 = await client.get_aggregate_bars(
                "TSLA210903C00700000",
                "2021-09-10",
                dt.date(2021, 10, 1),
                full_range=True,
            ...
            data3 = await client.get_aggregate_bars(
                "O:TSLA210903C00700000",
                "2021-09-10",
                dt.date(2021, 10, 1),
                full_range=True,
            ...
            data5 = await client.get_aggregate_bars(
                "TSLA210903C00700000",
                "2021-06-10",
                dt.date(2021, 10, 1),
                full_range=True,
            ...
            data6 = await client.get_aggregate_bars(
                "O:TSLA210903C00700000",
                "2021-06-10",
                dt.date(2021, 10, 1),
                full_range=True,
    ...
    async def test_async_get_snapshot(self):
        async with polygon.OptionsClient(cred.KEY, True) as client:
            ...
            data2 = await client.get_snapshot(
                "AAPL", "O:AAPL230616C00150000", raw_response=True
            )
            data3 = await client.get_snapshot(
                "AAPL", "O:AAPL230616C00150000", all_pages=True, max_pages=2
            )
            data4 = await client.get_snapshot(
                "AAPL",
                "O:AAPL230616C00150000",
                all_pages=True,
                max_pages=2,
    ...
    async def test_async_get_previous_close(self):
        async with polygon.OptionsClient(cred.KEY, use_async=True) as client:
            ...
            data2 = await client.get_previous_close(
                "O:TSLA210903C00700000", adjusted=True, raw_response=True
            )
