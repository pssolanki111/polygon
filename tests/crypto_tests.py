...
class TestCrypto(unittest.TestCase):
    def test_get_historic_crypto_trades(self):
        with polygon.CryptoClient(cred.KEY) as client:
            data = client.get_historic_trades(
                "BTC", "USD", "2021-10-15", limit=5)
            data2 = client.get_historic_trades(
                "BTC", "USD", datetime.date(2021, 10, 15), limit=5, raw_response=True
            )
    ...
    def test_get_trades(self):
        with polygon.CryptoClient(cred.KEY) as client:
            ...
            data2 = client.get_trades(
                "X:BTC-USD", datetime.date(2021, 10, 15), limit=5, raw_response=True
            )
            data3 = client.get_trades(
                "X:BTC-USD", limit=5, all_pages=True, max_pages=2)
            data4 = client.get_trades(
                "X:BTC-USD", limit=5, all_pages=True, max_pages=2, merge_all_pages=False
            )
    ...
    def test_get_daily_open_close(self):
        with polygon.CryptoClient(cred.KEY) as client:
            ...
            data2 = client.get_daily_open_close(
                "BTC", "USD", date=datetime.date(2021, 10, 15), raw_response=True
            )
    ...
    def test_get_aggregate_bars(self):
        with polygon.CryptoClient(cred.KEY) as client:
            data = client.get_aggregate_bars(
                "X:BTCUSD", "2021-09-10", datetime.date(2021, 10, 1), limit=30
            )
    ...
    def test_get_grouped_daily_bars(self):
        with polygon.CryptoClient(cred.KEY) as client:
            ...
            data2 = client.get_grouped_daily_bars(
                datetime.datetime(2021, 10, 15), raw_response=True
            )
    ...
    async def test_async_get_historic_crypto_trades(self):
        async with polygon.CryptoClient(cred.KEY, True) as client:
            ...
            data2 = await client.get_historic_trades(
                "BTC", "USD", datetime.date(2021, 10, 15), limit=5, raw_response=True
            )
    ...
    async def test_async_get_grouped_daily_bars(self):
        async with polygon.CryptoClient(cred.KEY, True) as client:
            ...
            data2 = await client.get_grouped_daily_bars(
                datetime.datetime(2021, 10, 15), raw_response=True
            )
