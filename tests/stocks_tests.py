...
class TestCommonMethods(unittest.TestCase):
    def test_change_enum_sync_base(self):
        ...
        test3 = base_client._change_enum(
            enums.StreamCluster.OPTIONS, [str, int])
        ...
        test7 = base_client._change_enum(
            enums.StockReportType.TRAILING_TWELVE_MONTHS_ANNUALIZED, [str, int]
        )
    ...
    def test_datetime_normalizer(self):
        ...
        test2 = client.normalize_datetime(
            datetime.date(2021, 6, 28), output_type="str")
        test3 = client.normalize_datetime(
            datetime.datetime(2021, 6, 28), output_type="str"
        )
        test4 = client.normalize_datetime("2021-06-28", _dir="end")
        test5 = client.normalize_datetime(
            datetime.datetime(2021, 6, 28, 13, 27, 34))
        test6 = client.normalize_datetime(
            pytz.timezone("Asia/Kolkata").localize(
                datetime.datetime(2021, 6, 28, 13, 27, 34)
            )
        )
        test7 = client.normalize_datetime(
            datetime.datetime(2021, 6, 28, 13, 27, 34), unit="ns"
        )
        test8 = client.normalize_datetime(
            1643816472, output_type="datetime", unit="s")
        test9 = client.normalize_datetime(
            1643816472000, output_type="datetime")
        test10 = client.normalize_datetime(
            1643816472000000000, output_type="datetime", unit="ns"
        )
        ...
        self.assertEqual(
            test8, datetime.datetime(2022, 2, 2, 15, 41, 12, tzinfo=pytz.utc)
        )
        self.assertEqual(
            test9, datetime.datetime(2022, 2, 2, 15, 41, 12, tzinfo=pytz.utc)
        )
        self.assertEqual(
            test10, datetime.datetime(2022, 2, 2, 15, 41, 12, tzinfo=pytz.utc)
        )
    ...
    def test_date_split(self):
        ...
        test2 = client.split_date_range(
            datetime.date(2021, 6, 4), datetime.date(2021, 12, 3), "min"
        )
        test3 = client.split_date_range(
            datetime.date(2021, 6, 5), datetime.date(2021, 12, 3), "hour"
        )
        test4 = client.split_date_range(
            "2021-06-05", datetime.date(2021, 12, 3), "year"
        )
        ...
        self.assertEqual(
            ...
            [
                (
                    ...
                    datetime.datetime(
                        2021, 12, 1, 23, 59, tzinfo=datetime.timezone.utc
                    ),
                ),
                (
            ...
            [
                (
                    datetime.datetime(2021, 12, 1, 0, 0,
                                      tzinfo=datetime.timezone.utc),
                    datetime.datetime(
                        2021, 12, 3, 23, 59, tzinfo=datetime.timezone.utc
                    ),
                ),
                (
...
class TestStocks(unittest.TestCase):
    def test_get_trades(self):
        with polygon.StocksClient(cred.KEY) as client:
            ...
            data1 = client.get_trades(
                "AMD", date=datetime.date(2021, 6, 28), limit=10, raw_response=True
            )
            data2 = client.get_trades(
                "AMD", date=datetime.datetime(2021, 6, 28), limit=10, raw_response=True
            )
            data3 = client.get_trades(
                "AMD", date="2021-06-28", limit=10, reverse=False)
            ...
            self.assertTrue(
                data["results"] == data1.json()["results"] == data2.json()[
                    "results"]
            )
    ...
    def test_get_trades_v3(self):
        with polygon.StocksClient(cred.KEY) as client:
            ...
            data1 = client.get_trades_v3(
                "AMD", datetime.date(2021, 6, 28), limit=10, raw_response=True
            )
            data2 = client.get_trades_v3(
                "AMD", datetime.datetime(2021, 6, 28), limit=10, raw_response=True
            )
            data3 = client.get_trades_v3("AMD", "2021-06-28", limit=10)
            data4 = client.get_trades_v3(
                "AMD", "2021-06-28", limit=5, all_pages=True, max_pages=2
            )
            data5 = client.get_trades_v3(
                "AMD",
                "2021-06-28",
                limit=5,
                all_pages=True,
    ...
    def test_get_quotes_v3(self):
        with polygon.StocksClient(cred.KEY) as client:
            ...
            data1 = client.get_quotes_v3(
                "AMD", datetime.date(2021, 6, 28), limit=10, raw_response=True
            )
            data3 = client.get_quotes_v3("AMD", "2021-06-28", limit=10)
            data4 = client.get_quotes_v3(
                "AMD", "2021-06-28", limit=5, all_pages=True, max_pages=2
            )
            data5 = client.get_quotes_v3(
                "AMD",
                "2021-06-28",
                limit=5,
                all_pages=True,
    ...
    def test_get_daily_open_close(self):
        with polygon.StocksClient(cred.KEY) as client:
            ...
            data1 = client.get_daily_open_close(
                "AMD", datetime.datetime(2021, 6, 28), raw_response=True
            )
            data2 = client.get_daily_open_close(
                "AMD", datetime.datetime(2021, 6, 28), raw_response=True, adjusted=False
            )
    ...
    def test_get_aggregate_bars(self):
        with polygon.StocksClient(cred.KEY) as client:
            data = client.get_aggregate_bars(
                "NVDA", "2020-06-28", "2021-06-28", limit=10
            )
            data1 = client.get_aggregate_bars(
                "NVDA",
                "2020-06-28",
    ...
    def test_get_grouped_daily_bars(self):
        with polygon.StocksClient(cred.KEY) as client:
            ...
            data2 = client.get_grouped_daily_bars(
                "2020-06-28", raw_response=True)
    ...
    def test_get_previous_close(self):
        with polygon.StocksClient(cred.KEY) as client:
            ...
            self.assertTrue(
                data["results"] == data1["results"] == data2.json()["results"]
            )
    ...
    async def test_async_get_trades_v3(self):
        async with polygon.StocksClient(cred.KEY, True) as client:
            ...
            data1 = await client.get_trades_v3(
                "AMD", datetime.date(2021, 6, 28), limit=10, raw_response=True
            )
            data2 = await client.get_trades_v3(
                "AMD", datetime.datetime(2021, 6, 28), limit=10, raw_response=True
            )
            data3 = await client.get_trades_v3("AMD", "2021-06-28", limit=10)
            data4 = await client.get_trades_v3(
                "AMD", "2021-06-28", limit=5, all_pages=True, max_pages=2
            )
            data5 = await client.get_trades_v3(
                "AMD",
                "2021-06-28",
                limit=5,
                all_pages=True,
    ...
    async def test_async_get_quotes_v3(self):
        async with polygon.StocksClient(cred.KEY, True) as client:
            ...
            data1 = await client.get_quotes_v3(
                "AMD", datetime.date(2021, 6, 28), limit=10, raw_response=True
            )
            data3 = await client.get_quotes_v3("AMD", "2021-06-28", limit=10)
            data4 = await client.get_quotes_v3(
                "AMD", "2021-06-28", limit=5, all_pages=True, max_pages=2
            )
            data5 = await client.get_quotes_v3(
                "AMD",
                "2021-06-28",
                limit=5,
                all_pages=True,
    ...
    async def test_async_get_daily_open_close(self):
        async with polygon.StocksClient(cred.KEY, True) as client:
            ...
            data1 = await client.get_daily_open_close(
                "AMD", datetime.datetime(2021, 6, 28), raw_response=True
            )
    ...
    async def test_async_get_aggregate_bars(self):
        async with polygon.StocksClient(cred.KEY, True) as client:
            ...
            data1 = await client.get_aggregate_bars(
                "NVDA",
                "2020-06-28",
                datetime.date(2021, 6, 28),
                limit=10,
